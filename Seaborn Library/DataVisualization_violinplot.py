'''
This script exemplifies usage of Seaborn Library violinplot.
...
# Lets see distribution of sepal_width for each species using the violinplot:
plt.figure(1)
sb.violinplot(x = 'species', y = 'sepal_width', data = IrisData)

# The orientation of the figure can be changed:
plt.figure(2)
sb.violinplot(y = 'species', x = 'sepal_width', data = IrisData, orient = 'h')
